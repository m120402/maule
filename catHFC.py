...
# Cat -> *2
	...
	def set_res_and_power_simple(self, speed = 2):
		# Used in optimization
...
# Cat -> *2
	...
	def update(self, x):
		...
		self.set_res_and_power_holtrop()
		# self.set_res_and_power_simple()
...
if __name__ == "__main__":
	...
	# print(h.calc_Rv_boat(boat, np.array([boat.V5, boat.V5 +2])))
